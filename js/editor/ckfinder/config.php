...
$config['LicenseKey'] = 'ND070000700A8000000000000P0';
// –ﬂ ¿≈÷¿ “”“  http://xdan.ru/Kak-ubrat-nadpis-Demo-v-ckFinder.html
/*
...
$year = date("Y");
$mount = date("n");
$baseUrl = '/upload/images/post/'.$year.'/'.$mount.'/';
...
If enabled, characters with diactric marks, like √•, √§, √∂, ƒá, ƒç, ƒë, ≈°
...
$config['plugin_imageresize']['smallThumb'] = '70x70';
$config['plugin_imageresize']['mediumThumb'] = '100x100';
$config['plugin_imageresize']['largeThumb'] = '150x150';
